...
func test_sparse_shop_interface_is_translated() -> void:
	var keys := [
		...
		&"recycle.checkout",
		&"recycle.window",
		&"recycle.feedback.ready",
		&"recycle.feedback.staged",
		&"recycle.feedback.paid",
		&"recycle.feedback.returned",
		&"recycle.feedback.special",
		&"recycle.feedback.not_owned",
		&"recycle.feedback.empty",
		&"recycle.feedback.invalid",
		&"recycle.feedback.pending",
		&"shop.next_day.title",
